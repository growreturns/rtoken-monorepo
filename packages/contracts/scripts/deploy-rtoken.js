...
module.exports = async function (callback) {
    try {
        ...
        if (!newRtokenName || !newRtokenSymbol || !cTokenAddress) {
        ...
        const rTokenConstructCode = rToken.contract.methods.initialize(compoundAS.address, newRtokenName, newRtokenSymbol, 18)
            .encodeABI();
